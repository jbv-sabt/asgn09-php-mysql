...
(1, 'Southern Red-Backed', 'These salamanders are found in the mountains of northwestern North Carolina, in a small area of the central Piedmont, and in much of the Coastal Plain.  These terrestrial salamanders are largely confined to forested areas and may be found under rocks, logs, and other cover objects during the day.', 'There are two distinct color morphs of the southern red-backed salamander.  The striped morph has a dark grey or brown base color with an orange or red stripe stretching from the head to the end of the tail.'),
...
GRANT ALL PRIVILEGES ON salamanders.* TO 'cpses_jbza78svhs'@'localhost' IDENTIFIED BY '*1C429C28DF15D76358B5986F5CBAAD1EC4CCB601';;
FLUSH PRIVILEGES;